...
const AutoComplete = ({placeholder,value,onChange,onKeyDown,list = [],selectedList = [],onSelect,onRemove,label='name',id='id'}) => {
        ...
        <div className='w-full flex flex-col gap-2'>
            <div className="w-full relative">
                <IconField iconPosition="right">
                    ...
                    <InputText type="text" ref={spinRef} value={value} onChange={onChange} onKeyDown={onKeyDown} placeholder={placeholder} className="w-full py-2 focus-within:border-green-800 focus:border-(--primary-color) focus:border-2 focus:shadow-none" />
                </IconField>
